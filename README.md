...
XGBoost Risk Prediction Model
      ↓
Probability-Based Risk Logic
      ↓
Clinical Explanation Engine
      ↓
Hindi Text + Offline Voice
      ↓
Frontline Health Worker Action
...
High-risk recall prioritized for clinical safety

⚠️ In healthcare, reducing false negatives for high-risk cases is prioritized over raw accuracy.
...
Focused on building real-world, impact-driven AI systems
